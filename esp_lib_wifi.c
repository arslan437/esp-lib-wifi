...
static void event_handler_st(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
...
void init_wifi_ap()
{
    ...
    ESP_LOGI(TAG, "wifi_init_softap finished. SSID:%s password:%s channel:%d",
             DEFAULT_AP_SSID, DEFAULT_AP_PASS, 1);
}
